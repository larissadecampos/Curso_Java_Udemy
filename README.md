...
- Criação dos primeiros programas em Java.  
- Desenvolvimento com variáveis, funções e estruturas de controle.  
- Implementação de conceitos de Orientação a Objetos (classes, herança, polimorfismo).  
